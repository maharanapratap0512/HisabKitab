!(function (i) {
    ...
    (function (a) {
        ...
        (t.prototype._selectOptionsFromConfig = function () {
            ...
            if (t) {
                switch ((a("input[type=checkbox][name=color-scheme-mode]").prop("checked", !1), t.sideBarTheme)) {
                    case "default":
                ...
                switch ((a("input[type=checkbox][name=theme]").prop("checked", !1), t.sideBarTheme)) {
                    case "default":
                        a("#default-check").prop("checked", !0);
                        break;
                    case "light":
    ...
    (function (a) {
        ...
        (t.prototype._saveConfig = function (t) {
            ...
            (t.prototype.activateDarkMode = function () {
                console.log('activateDarkMode called');
                var t = this;
                this.body.css("visibility", "hidden"),
                    ...
                    this._saveConfig({ isDarkModeEnabled: !0, sideBarTheme: i });
            }),
    ...
    (function (n) {
        ...
        (t.prototype.initSelect2 = function () {
            ...
            (t.prototype.init = function () {
                this.initMask(), this.initDateRange(), this.initTimePicker(), this.initTouchspin(), this.initMaxlength();
            }),
    ...
    (function (a) {
        ...
        (t.prototype.activateDefaultSidebarTheme = function () {
            ...
            (t.prototype.init = function () {
                ...
                document.getElementById("light-style").href.includes("rtl.min.html") && (document.getElementsByTagName("html")[0].dir = "rtl"),
                    document.getElementById("dark-style").href.includes("rtl.min.html") && (document.getElementsByTagName("html")[0].dir = "rtl");
            }),
            (a.App = new t()),
            (a.App.Constructor = t);
    })(window.jQuery),
...
// console.log("hello--------", window.jQuery.App.activateDarkMode()   );
